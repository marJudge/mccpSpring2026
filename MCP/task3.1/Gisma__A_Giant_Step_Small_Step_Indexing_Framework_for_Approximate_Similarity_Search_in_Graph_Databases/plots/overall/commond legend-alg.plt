...
#plot 'title' u 1 w histogram ls 6 t "BFA"
#plot 'title' u 1 w histogram ls 1 fill pattern 2 t "TAP"
plot 'title' u 1 w histogram ls 1 fill pattern 4 t "BFQ"

set key at graph 0.50, graph 0.1 center maxrows 1
#plot 'title' u 2 w histogram ls 7 t "BFA^+" 
plot 'title' u 2 w histogram ls 4 fill pattern 3 t "BFQ^+"
...
plot 'title' u 3 w histogram ls 2 fill pattern 5 t "BFQ*"